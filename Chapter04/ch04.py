...
class_mapping = {label: idx for idx, label in enumerate(np.unique(df['classlabel']))}  # enumerate 枚举函数
class_mapping
...
ohe = ColumnTransformer(transformers=[("color", OneHotEncoder(), [0])], remainder='passthrough')
